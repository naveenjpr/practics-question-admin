        ...
        ? mydata.map((v, i) => {
            return (
              <div key={i} className="mb-2 w-full">
                ...
                >
                  <h4 className="text-[20px] text-gray-600 group-hover:text-white  ">
                    {v.icon}
                  </h4>

                  <ul
                    className={`text-white group-hover:visible group-hover:opacity-[1] w-[220px] invisible opacity-0 z-[99] text-[14px] min-h-[100px] ease-in-out px-[50px] duration-[0.8s] absolute left-[100%] top-0 bg-[#4B49AC]`}
                  >
                    <h4 className="text-[15px] text-left pb-3 pt-2 text-white">
                      {v.uid}
                    </h4>

                    <Link to={v.link1}>
                      <li className="flex items-center pl-4 mb-2">
                        <FontAwesomeIcon
                          icon={faCircle}
              ...
              <div key={i} className="mb-2 w-full">
                <div
                  ...
                  className={` flex items-center justify-between hover:bg-[#4B49AC] hover:text-white   duration-[0.3s] py-3 px-4  ${
                    v.id == menu
                      ? "rounded-[10px_10px_0px_0px] bg-[#4B49AC] text-white"
