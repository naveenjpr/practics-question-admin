...
import { PythonUrl } from '../../Common/MenuData'

export default function Viewpython() {
            ...
            <div className="flex  bg-[#F5F7FF]">
                ...
                >
                    <h1 className="text-[25px] font-[500] mb-[10px]">
                        Welcome To &nbsp;<u>Python</u> &nbsp; Admin Panel
                    </h1>
                    <div className="">
                        <div className="bg-white w-[100%] mb-[50px] p-4 h-full rounded-[20px]">
                            {loading ? (
                                <LoadingSpinner message="Loading Python questions..." />
                                            ...
                                            <div className="p-2 mt-1 text-white bg-black">
                                                ...
                                                <div className="flex justify-end mt-4 space-x-2">
                                                    ...
                                                    <button className="flex gap-2 justify-center items-center px-3 h-9 text-sm font-medium whitespace-nowrap rounded-md border border-input bg-background hover:bg-accent">
                                                        <Link to={`/Addpython/${v._id}`}>Edit</Link>
                                                    </button>
                                                    <button
